...
Request
  ...
  curl -X POST --header "Accept: application/xml" --header \
  "Content-Type: application/xml" http://localhost:3000/target_images --data \
  "<target_image>
    <image_version id='2' />
  </target_image>"
...
<target_image href='http://localhost:3000/target_images/1' id='1'>
  <target>EC2</target>
...
Request
  ...
  curl --header "Accept: application/xml" http://localhost:3000/target_images/1
...
Request
  ...
  curl --header "Accept: application/xml" http://localhost:3000/target_images
...
Response
  ...
  <target_images>
    <target_image href='http://localhost:3000/target_images/1' id='1'></target_image>
    <target_image href='http://localhost:3000/target_images/2' id='2'></target_image>
    <target_image href='http://localhost:3000/target_images/3' id='3'></target_image>
  </target_images>
...
Request
  ...
  curl -X DELETE --header "Accept: application/xml" http://localhost:3000/target_images/1
...
Request
  ...
  curl -X PUT --header "Accept: application/xml" --header \
  "Content-Type: application/xml" http://localhost:3000/target_images/2 --data \
  "<target_image>
...
Request
  ...
  curl -X POST --header "Accept: application/xml" --header \
  "Content-Type: application/xml" http://localhost:3000/provider_images --data \
  "<provider_image>
    <target_image id='1' />
  </provider_image>"
...
Response
  ...
  <provider_image href='http://localhost:3000/provider_images/85' id='85'>
...
Request
  ...
  curl --header "Accept: application/xml" http://localhost:3000/provider_images/1
...
Request
  ...
  curl --header "Accept: application/xml" http://localhost:3000/provider_images
...
Response
  ...
  <provider_images>
    <provider_image href='http://localhost:3000/provider_images/1' id='1'></provider_image>
    <provider_image href='http://localhost:3000/provider_images/2' id='2'></provider_image>
    <provider_image href='http://localhost:3000/provider_images/3' id='3'></provider_image>
  </provider_image>
...
Request
  ...
  curl -X DELETE --header "Accept: application/xml" http://localhost:3000/provider_images/1
...
Request
  ...
  curl -X PUT --header "Accept: application/xml" --header \
  "Content-Type: application/xml" http://localhost:3000/provider_images/2 --data \
  "<provider_image>
...
Response
  ...
  <provider_image href='http://localhost:3000/provider_images/84' id='84'>
    <provider></provider>
